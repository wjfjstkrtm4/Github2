 ...
 * GregorianCalendar
   ...
   class MyApp{
     static void main(){
      Calendar cal = new GregorianCalendar(); .. 태국 제외하고 사용 // 만약 태국나라에서 쓸려면 바꿔줘야함
      다른 종류의 역법의 사용하는 국가에서 실행하면 변경......    }  }
   class MyApp{
     static void main(){
      Calendar cal = Calendar.getInstance(); // os가 가지고있는 역법에 맞게 태국, 다른나라 다됨
        다른 종류의 역법의 사용하는 국가에서 실행하면 변경......   }  }
...
public class Ex08_Calendar {
	public static void main(String[] args) {
		...
		Calendar cal = Calendar.getInstance();// 싱글톤이라기보다는 
